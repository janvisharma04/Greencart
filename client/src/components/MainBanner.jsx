  ...
  return (
    <div className='relative'> 
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-100 lg:max-w-130 leading-titght lg:leading-15'>Greencart – Freshness Just a Click Away</h1>
