    ...
    return product && (
        <div className="mt-12 ">
                ...
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product.image.map((image, index) => (
                            <div key={index} onClick={() => setThumbnail(image)} className="border max-w-24 h-24 flex items-center border-gray-500/30 rounded overflow-hidden cursor-pointer bg-white" >
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className="mx-auto cusrsor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition">See more</button>
            </div>
        </div>
    );
};
